...
import glob
import sys
hdf5_path = 'ilsvrc_test.hdf5'
img_path = '/data1/nithish/WORK/Resources/Datasets/IMAGENET/val/*.png'
...
print "{} {}".format("Length of valid list",len(valid_list))
...
for i in range(len(train_addrs)):
    ...
    img = imread(valid_list[i])
   
    img = resize(img, (224, 224))*255.0
    img2 = img
    img = img.reshape((1,size,size,3))
 
    hdf5_file["test_img"][i, ...] = img2
